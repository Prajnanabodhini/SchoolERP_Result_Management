...
<style>
    ...
    */
    ...
    .exam-master-table tbody tr:hover {
        background: #FEFCE8;
    }
    ...
    */
    ...
    @media (max-width: 800px) {
        ...
        .exam-master-page .header-row {
            flex-direction: column;
            align-items: stretch;
            gap: 10px;
        }

        .exam-master-page .header-row .erp-btn {
            width: 100%;
        }
    }
</style>
...
<div class="max-w-7xl mx-auto py-4 px-4 exam-master-page">
    ...
    >
        ...
        <div class="flex justify-between items-center mb-4 header-row">
                ...
                <tbody>
                    ...
                    @forelse($examMasters as $exam)
                        ...
                        <tr>
                            ...
                            <td class="border text-center whitespace-nowrap action-cell">
