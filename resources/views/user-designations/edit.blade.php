        ...
        >
            ...
            <div class="form-grid">
                            ...
                            @foreach($designations as $designation)
                                ...
                                <option
                                    ...
                                    {{
                                        old(
                                            'designation_id',
                                            $userDesignation->designation_id
                                        )
                                        == $designation->id
                                            ? 'selected'
                                            : ''
                            ...
                            @foreach($academicYears as $year)
                                ...
                                <option
                                    ...
                                    {{
                                        old(
                                            'academic_year_id',
                                            $userDesignation->academic_year_id
                                        )
                                        == $year->id
                                            ? 'selected'
                                            : ''
                ...
                <div class="help-box">
                    ...
                    Standard and Division are automatically ignored.
