...
<div class="bg-gradient-to-br from-red-100 via-yellow-100 to-orange-100 rounded-xl shadow-xl border-4 border-amber-400 p-5">
    ...
    <h2 class="text-2xl font-bold text-blue-700 text-center mb-5">
        Edit Subject Type
    </h2>

    <form method="POST"
          action="{{ route('subject-types.update', $subjectType->id) }}">
        ...
        <div class="mb-4">
            ...
            <textarea name="description"
                      class="w-full border rounded p-2"
                      rows="2">{{ $subjectType->description }}</textarea>
